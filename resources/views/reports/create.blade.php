...
@section('content')
    <div class="container mx-auto px-4">
        <h1 class="text-4xl font-bold my-7 text-center">Add New Report</h1>
        ...
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <form action="{{ route('reports.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="kode_pemeriksaan" name="kode_pemeriksaan"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>

                <div class="mb-4">
                    <label for="tanggal_pemeriksaan" class="block text-gray-700 text-sm font-bold mb-2">Tanggal
                        Pemeriksaan:</label>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="pengobatan" name="pengobatan"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
